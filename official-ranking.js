...
function eventTypeOf(discipline,code){const n=normEvt(discipline);if(code==='Decathlon'){if(n.startsWith('decathlon'))return'main';if(n.startsWith('heptathlon'))return'similar';return null;}if(code==='Heptathlon'){if(n.startsWith('heptathlon'))return'main';if(n.startsWith('pentathlon'))return'similar';return null;}return exactMatchEvt(discipline,code)?'main':null;}
