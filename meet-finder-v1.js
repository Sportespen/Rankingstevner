...
// WA's own competition-category letters, highest to lowest prestige - same order/tiering the
// Placing Score bonus tables (see ranking-basis.js/trinn3.js) already use. Shown as a native
// tooltip on hover (both the filter dropdown and each card's category badge) since the bare
// letters mean nothing on their own to someone not already familiar with WA's system.
