...
export async function onRequestGet(context){
  ...
  return json({ok:true,id:Number(id),event,name,rank:knownRank,rankScope:knownRank?'world':null,europeanRank:null,score:null,verifiedPublished:false,basisVerified:false,basis:[],diagnostics});
}
