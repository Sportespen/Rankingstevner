...
(function(){
  ...
  function loadBasis(){if(document.querySelector('script[data-ranking-basis-v221]'))return;const s=document.createElement('script');s.src='ranking-basis.js?v=221';s.dataset.rankingBasisV221='1';document.head.appendChild(s);}
